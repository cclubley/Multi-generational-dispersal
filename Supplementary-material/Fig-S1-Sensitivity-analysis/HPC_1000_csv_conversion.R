...
# Load netCDF file
mydata <- nc_open("./Model outputs/2000_Random_1000_10_4_14_passive_2D_1deg_output.nc")
...
write.csv(mydata, "./csv file/2000_Random_1000_10_4_14_passive_2D_1deg_settled.csv", row.names = FALSE)
