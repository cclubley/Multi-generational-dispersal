...
ufiles = '2008_shelftmb_grid_U.nc' 
vfiles = '2008_shelftmb_grid_V.nc' 
...
ufields = xr.open_dataset('2008_shelftmb_grid_U.nc')
vfields = xr.open_dataset('2008_shelftmb_grid_V.nc')
...
spawninglocs = pd.read_csv('Spawning_locations_2008_28_1_deg.csv')
...
start_time = datetime(2008, 7, 15).toordinal()
end_time = datetime(2008, 8, 16).toordinal()
...
output_file = pset.ParticleFile(name="2008_Random_100000_passive_2D_1deg_output.nc", outputdt=delta(hours=4))
