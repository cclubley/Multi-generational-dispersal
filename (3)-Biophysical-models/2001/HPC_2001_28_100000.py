...
ufiles = '2001_shelftmb_grid_U.nc' 
vfiles = '2001_shelftmb_grid_V.nc' 
...
ufields = xr.open_dataset('2001_shelftmb_grid_U.nc')
vfields = xr.open_dataset('2001_shelftmb_grid_V.nc')
...
spawninglocs = pd.read_csv('Spawning_locations_2001_28_1_deg.csv')
...
start_time = datetime(2001, 7, 15).toordinal()
end_time = datetime(2001, 8, 16).toordinal()
...
output_file = pset.ParticleFile(name="2001_Random_100000_passive_2D_1deg_output.nc", outputdt=delta(hours=1))

pset.execute(kernels, runtime=delta(days=46), dt=delta(minutes=5), recovery ={ErrorCode.ErrorOutOfBounds: DeleteParticle, ErrorCode.ErrorInterpolation: DeleteParticle}, output_file = output_file)                             
