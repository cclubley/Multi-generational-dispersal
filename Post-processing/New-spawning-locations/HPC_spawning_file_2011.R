...
# Load csv data
mydata <- read.csv("./csv file/2011_28_Random_100000_passive_2D_1deg_settled.csv")
...
write.csv(grid_centres, "./New spawning locations/Spawning_locations_2012_28_1_deg.csv", row.names = FALSE)

# Load csv data
mydata <- read.csv("./csv file/2011_25_Random_100000_passive_2D_1deg_settled.csv")
...
write.csv(grid_centres, "./New spawning locations/Spawning_locations_2012_25_1_deg.csv", row.names = FALSE)

print("Spawning locations - 17 days")

# Load csv data
mydata <- read.csv("./csv file/2011_17_Random_100000_passive_2D_1deg_settled.csv")
...
write.csv(grid_centres, "./New spawning locations/Spawning_locations_2012_17_1_deg.csv", row.names = FALSE)

print("Spawning locations - 14 days")

# Load csv data
mydata <- read.csv("./csv file/2011_14_Random_100000_passive_2D_1deg_settled.csv")
...
write.csv(grid_centres, "./New spawning locations/Spawning_locations_2012_14_1_deg.csv", row.names = FALSE)
