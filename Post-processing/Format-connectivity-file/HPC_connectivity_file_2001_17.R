...
print("Loading data...")
# Load csv data
mydata <- read.csv("./csv file/2001_17_Random_100000_passive_2D_1deg_settled.csv")
...
connectivity_data <- connectivity_data[!(connectivity_data$Source_ID==638|connectivity_data$Source_ID==639|connectivity_data$Source_ID==640|
                            |connectivity_data$Source_ID==782|connectivity_data$Source_ID==783|connectivity_data$Source_ID==784|connectivity_data$Source_ID==826
                            |connectivity_data$Source_ID==827|connectivity_data$Source_ID==830|connectivity_data$Source_ID==845|connectivity_data$Source_ID==888
                            |connectivity_data$Source_ID==889|connectivity_data$Source_ID==926|connectivity_data$Source_ID==1313|connectivity_data$Source_ID==1362
                            |connectivity_data$Source_ID==1363),]

print("Writing file...")
# Write to file
write.csv(connectivity_data, "./Connectivity/2001_17_Random_100000_passive_2D_1deg_connectivity.csv", row.names = FALSE)
