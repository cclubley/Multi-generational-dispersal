...
connectivity_data <- connectivity_data[!(connectivity_data$Source_ID==830|connectivity_data$Source_ID==888
                      |connectivity_data$Source_ID==889|connectivity_data$Source_ID==1362),]

print("Writing to file...")
# Write to file
write.csv(connectivity_data, "./Connectivity/2001_25_Random_100000_passive_2D_1deg_connectivity.csv", row.names = FALSE)
