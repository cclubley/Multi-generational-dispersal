...
print("Loading data...")
# Load csv data
mydata <- read.csv("./csv file/2002_14_Random_100000_passive_2D_1deg_settled.csv")
...
connectivity_data <- connectivity_data[!(connectivity_data$Source_ID==457|connectivity_data$Source_ID==590|connectivity_data$Source_ID==747
                               |connectivity_data$Source_ID==748|connectivity_data$Source_ID==749|connectivity_data$Source_ID==779|connectivity_data$Source_ID==786
                               |connectivity_data$Source_ID==787|connectivity_data$Source_ID==788|connectivity_data$Source_ID==789|connectivity_data$Source_ID==829
                               |connectivity_data$Source_ID==835|connectivity_data$Source_ID==836|connectivity_data$Source_ID==837|connectivity_data$Source_ID==884
                               |connectivity_data$Source_ID==894|connectivity_data$Source_ID==1124|connectivity_data$Source_ID==1125|connectivity_data$Source_ID==1310
                               |connectivity_data$Source_ID==1311|connectivity_data$Source_ID==1359|connectivity_data$Source_ID==1360|connectivity_data$Source_ID==1410
                               |connectivity_data$Source_ID==1411), ]

print("Writing file...")
# Write to file
write.csv(connectivity_data, "./Connectivity/2002_14_Random_100000_passive_2D_1deg_connectivity.csv", row.names = FALSE)
