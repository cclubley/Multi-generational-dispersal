...
connectivity_data <- connectivity_data[!(connectivity_data$Source_ID==493|connectivity_data$Source_ID==494|connectivity_data$Source_ID==541
                                         |connectivity_data$Source_ID==542|connectivity_data$Source_ID==543), ]

print("Writing file...")
# Write to file
write.csv(connectivity_data, "./Connectivity/2003_28_Random_100000_passive_2D_1deg_connectivity.csv", row.names = FALSE)
