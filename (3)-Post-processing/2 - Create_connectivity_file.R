# -------------------------------------------------------------------------
# --------- Processing the output data for connectivity analysis ----------
# -------------------------------------------------------------------------
# -------------------------------------------------------------------------

# The following script takes the .csv file that was created in the 
# 'Csv_conversion_annotated_script' and processes it to make the data suitable 
# for connectivity analysis using graph network. In doing this I use the same 
# spatial grid that was used to generate spawning locaitons to assign the source 
# and sink location of each particle a 'polygon ID'. In this was, spatial bias
