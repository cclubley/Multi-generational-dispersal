...
# Write the data 
setwd("C:/Users/charl/Documents/PhD/Chapters/(3) Dispersal Limitation/(4) Results/(1) Graph-level analysis/(Fig 3) Averaged link weight")
#write.csv(myFreqs, "./Weighted_average_graph_new.csv", row.names=FALSE)

# Load the previously saved data
myFreqs <- read.csv("./Weighted_average_graph_new.csv")
...
# Self-recruitment accounted for 24.8144% of edge weight
