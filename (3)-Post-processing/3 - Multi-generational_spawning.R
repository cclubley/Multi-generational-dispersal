# -------------------------------------------------------------------------
# ------- Generating new spawning locations for the following year --------
# -------------------------------------------------------------------------
# -------------------------------------------------------------------------

# The following script takes the .csv file that was created in the 
# 'Csv_conversion_annotated_script' and processes it to generate a new set of 
...
# I then repeat the above process for the remaining PLDs (25, 17 and 14 days), 
