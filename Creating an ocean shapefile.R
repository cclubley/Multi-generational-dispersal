# -------------------------------------------------------------------------
# ----------------- Creating a high resolution ocean grid -----------------
# -------------------------------------------------------------------------
# -------------------------------------------------------------------------

# The following script creates a 1 degre reolution grid over the ocean areas of 
# the study domain (north-west Europe). This grid is used in the creation of the
# settlement grid, which in turn is used to generate spawning locations and 
# in the creation of the settlement grid. High resolution country shapefiles
# are used to create the grid to try to preserve complex coastlines like fjord
# and estuary areas.

# Set working directory ---------------------------------------------------
setwd("C:/Users/cclubley/OneDrive - University of Plymouth/Data chapters/Dispersal Limitation/Release file/Shapefiles")
...
# Set the working directory to the location to which the downloaded shapefiles will be saved
setwd("C:/Users/cclubley/OneDrive - University of Plymouth/Data chapters/Dispersal Limitation/Release file/Shapefiles/Country Shapefiles")
...
# To read in the shapefile once it has been saved 
#setwd("C:/Users/cclubley/OneDrive - University of Plymouth/Data chapters/Dispersal Limitation/Release file/Shapefiles/Ocean Shapefile")
#oceans <- readOGR(dsn=".", layer="oceans")
...
# Save ocean grid to working directory ------------------------------------
writeOGR(obj=ocean_grid, dsn=".", layer="ocean_grid", driver="ESRI Shapefile")
