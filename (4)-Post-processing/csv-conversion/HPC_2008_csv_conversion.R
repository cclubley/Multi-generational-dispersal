...
# Load netCDF file
mydata <- nc_open("./Model outputs/2008_Random_100000_passive_2D_1deg_output.nc")
...
write.csv(mydata, "./csv file/2008_28_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
...
write.csv(mydata, "./csv file/2008_25_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
...
write.csv(mydata, "./csv file/2008_17_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
...
write.csv(mydata, "./csv file/2008_14_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
