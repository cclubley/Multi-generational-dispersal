...
print("Loading data...")
# Load csv data
mydata <- read.csv("./csv file/2003_17_Random_100000_passive_2D_1deg_settled.csv")
...
connectivity_data <- connectivity_data[!(connectivity_data$Source_ID==366|connectivity_data$Source_ID==367|connectivity_data$Source_ID==493
                                         |connectivity_data$Source_ID==494|connectivity_data$Source_ID==541|connectivity_data$Source_ID==542|connectivity_data$Source_ID==553
                                         |connectivity_data$Source_ID==554|connectivity_data$Source_ID==601|connectivity_data$Source_ID==602|connectivity_data$Source_ID==649
                                         |connectivity_data$Source_ID==697|connectivity_data$Source_ID==1355|connectivity_data$Source_ID==1403|connectivity_data$Source_ID==1404), ]

print("Writing file...")
# Write to file
write.csv(connectivity_data, "./Connectivity/2003_17_Random_100000_passive_2D_1deg_connectivity.csv", row.names = FALSE)
