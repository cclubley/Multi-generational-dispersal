...
connectivity_data <- connectivity_data[!(connectivity_data$Source_ID==392|connectivity_data$Source_ID==444|connectivity_data$Source_ID==1354
                                         |connectivity_data$Source_ID==1402), ]

print("Writing file...")
# Write to file
write.csv(connectivity_data, "./Connectivity/2004_14_Random_100000_passive_2D_1deg_connectivity.csv", row.names = FALSE)
