...
connectivity_data <- connectivity_data[!(connectivity_data$Source_ID==392|connectivity_data$Source_ID==444|connectivity_data$Source_ID==445
                                         |connectivity_data$Source_ID==446|connectivity_data$Source_ID==447|connectivity_data$Source_ID==494|connectivity_data$Source_ID==495
                                         |connectivity_data$Source_ID==638), ]

print("Writing file...")
# Write to file
write.csv(connectivity_data, "./Connectivity/2004_28_Random_100000_passive_2D_1deg_connectivity.csv", row.names = FALSE)
