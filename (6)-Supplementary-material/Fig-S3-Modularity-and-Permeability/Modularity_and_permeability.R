...
setwd("C:/Users/cclubley/OneDrive - University of Plymouth/Data chapters/(2) Dispersal Limitation/(4) Results/igraph creation and data extraction/Data/igraph environments")
...
# Read in the modularity data
mod <- read.csv("Modularity.csv")
