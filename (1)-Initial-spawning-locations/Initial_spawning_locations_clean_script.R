...
# Set the wd and load packages --------------------------------------------
setwd("C:/Users/cclubley/OneDrive - University of Plymouth/Data chapters/(2) Dispersal Limitation/(3) Methods/Modelling/Original release file/Final scripts and data")
{library(dplyr)
library(sp)
library(rgdal)
}
...
setwd("C:/Users/cclubley/OneDrive - University of Plymouth/Data chapters/(1) Rate of spread/Data/Data - 2022/Final spreadsheet")
...
setwd("C:/Users/cclubley/OneDrive - University of Plymouth/Data chapters/(2) Dispersal Limitation/(3) Methods/(Fig 2) Establishment proxy/Establishment-based grid")
