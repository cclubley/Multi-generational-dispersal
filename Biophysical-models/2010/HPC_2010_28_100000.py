...
ufiles = '2010_shelftmb_grid_U.nc' 
vfiles = '2010_shelftmb_grid_V.nc' 
...
ufields = xr.open_dataset('2010_shelftmb_grid_U.nc')
vfields = xr.open_dataset('2010_shelftmb_grid_V.nc')
...
spawninglocs = pd.read_csv('Spawning_locations_2010_28_1_deg.csv')
...
start_time = datetime(2010, 7, 15).toordinal()
end_time = datetime(2010, 8, 16).toordinal()
...
output_file = pset.ParticleFile(name="2010_Random_100000_passive_2D_1deg_output.nc", outputdt=delta(hours=4))
