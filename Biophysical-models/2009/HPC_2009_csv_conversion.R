...
# Load netCDF file
mydata <- nc_open("./Model outputs/2009_Random_100000_passive_2D_1deg_output.nc")
...
write.csv(mydata, "./csv file/2009_28_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
...
write.csv(mydata, "./csv file/2009_25_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
...
write.csv(mydata, "./csv file/2009_17_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
...
write.csv(mydata, "./csv file/2009_14_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
