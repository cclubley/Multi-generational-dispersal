...
connectivity_data <- connectivity_data[!(connectivity_data$Source_ID==392|connectivity_data$Source_ID==444|connectivity_data$Source_ID==445
                                         |connectivity_data$Source_ID==446|connectivity_data$Source_ID==447|connectivity_data$Source_ID==492|connectivity_data$Source_ID==493), ]

print("Writing file...")
# Write to file
write.csv(connectivity_data, "./Connectivity/2004_17_Random_100000_passive_2D_1deg_connectivity.csv", row.names = FALSE)