...
# Load netCDF file
mydata <- nc_open("./Model_outputs/2012_Random_100000_passive_2D_1deg_output.nc")
...
write.csv(mydata, "./csv file/2012_28_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
...
write.csv(mydata, "./csv file/2012_25_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
...
write.csv(mydata, "./csv file/2012_17_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
...
write.csv(mydata, "./csv file/2012_14_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
