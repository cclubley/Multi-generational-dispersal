...
connectivity_data <- connectivity_data[!(connectivity_data$Source_ID==543|connectivity_data$Source_ID==1403|connectivity_data$Source_ID==1404), ]

print("Writing to file...")
# Write to file
write.csv(connectivity_data, "./Connectivity/2003_25_Random_100000_passive_2D_1deg_connectivity.csv", row.names = FALSE)