...
ufiles = '2004_shelftmb_grid_U.nc' 
vfiles = '2004_shelftmb_grid_V.nc' 
...
ufields = xr.open_dataset('2004_shelftmb_grid_U.nc')
vfields = xr.open_dataset('2004_shelftmb_grid_V.nc')
...
spawninglocs = pd.read_csv('Spawning_locations_2004_1_deg.csv')
...
start_time = datetime(2004, 7, 15).toordinal()
end_time = datetime(2004, 8, 16).toordinal()
...
output_file = pset.ParticleFile(name="2004_Random_100000_passive_2D_1deg_output.nc", outputdt=delta(hours=4))
