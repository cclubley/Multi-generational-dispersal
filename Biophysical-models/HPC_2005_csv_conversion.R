...
# Load netCDF file
mydata <- nc_open("./Model outputs/2005_Random_100000_passive_2D_1deg_output.nc")
...
write.csv(mydata, "./csv file/2005_28_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
...
write.csv(mydata, "./csv file/2005_25_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
...
write.csv(mydata, "./csv file/2005_17_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
...
write.csv(mydata, "./csv file/2005_14_Random_100000_passive_2D_1deg_settled.csv", row.names = FALSE)
