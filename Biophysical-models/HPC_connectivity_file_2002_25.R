...
connectivity_data <- connectivity_data[!(connectivity_data$Source_ID==1359), ]

print("Writing to file...")
# Write to file
write.csv(connectivity_data, "./Connectivity/2002_25_Random_100000_passive_2D_1deg_connectivity.csv", row.names = FALSE)