...
ufiles = '2003_shelftmb_grid_U.nc' 
vfiles = '2003_shelftmb_grid_V.nc' 
...
ufields = xr.open_dataset('2003_shelftmb_grid_U.nc')
vfields = xr.open_dataset('2003_shelftmb_grid_V.nc')
...
spawninglocs = pd.read_csv('Spawning_locations_2003_1_deg.csv')
...
start_time = datetime(2003, 7, 15).toordinal()
end_time = datetime(2003, 8, 16).toordinal()
...
output_file = pset.ParticleFile(name="2003_Random_100000_passive_2D_1deg_output.nc", outputdt=delta(hours=4))
