...
connectivity_data <- connectivity_data[!(connectivity_data$Source_ID==590|connectivity_data$Source_ID==779|connectivity_data$Source_ID==1124|
                                           connectivity_data$Source_ID==1359|connectivity_data$Source_ID==1360), ]

print("Writing file...")
# Write to file
write.csv(connectivity_data, "./Connectivity/2002_17_Random_100000_passive_2D_1deg_connectivity.csv", row.names = FALSE)
