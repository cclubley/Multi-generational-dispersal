...
# Load csv data
mydata <- read.csv("./csv file/2002_28_Random_100000_passive_2D_1deg_settled.csv")
...
write.csv(grid_centres, "./New spawning locations/Spawning_locations_2003_28_1_deg.csv", row.names = FALSE)

# Load csv data
mydata <- read.csv("./csv file/2002_25_Random_100000_passive_2D_1deg_settled.csv")
...
write.csv(grid_centres, "./New spawning locations/Spawning_locations_2003_25_1_deg.csv", row.names = FALSE)

print("Spawning locations - 17 days")

# Load csv data
mydata <- read.csv("./csv file/2002_17_Random_100000_passive_2D_1deg_settled.csv")
...
write.csv(grid_centres, "./New spawning locations/Spawning_locations_2003_17_1_deg.csv", row.names = FALSE)
...
write.csv(grid_centres, "./New spawning locations/Spawning_locations_2003_14_1_deg.csv", row.names = FALSE)
